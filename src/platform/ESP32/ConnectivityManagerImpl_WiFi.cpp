...
void ConnectivityManagerImpl::OnStationConnected()
{
    ...
    if (delegate)
    {
        delegate->OnConnectionStatusChanged(
            static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::WiFiConnectionStatus::kConnected));
    }
...
void ConnectivityManagerImpl::OnStationDisconnected()
{
    ...
    uint8_t associationFailureCause =
        static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::AssociationFailureCause::kUnknown);
    ...
    case WIFI_REASON_PAIRWISE_CIPHER_INVALID:
        associationFailureCause =
            static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::AssociationFailureCause::kAssociationFailed);
        if (delegate)
        {
    ...
    case WIFI_REASON_802_1X_AUTH_FAILED:
        associationFailureCause =
            static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::AssociationFailureCause::kAuthenticationFailed);
        if (delegate)
        {
            delegate->OnAssociationFailureDetected(associationFailureCause, reason);
        }
    ...
    case WIFI_REASON_NO_AP_FOUND:
        associationFailureCause =
            static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::AssociationFailureCause::kSsidNotFound);
        if (delegate)
        {
            delegate->OnAssociationFailureDetected(associationFailureCause, reason);
        }
    ...
    if (delegate)
    {
        ...
        delegate->OnConnectionStatusChanged(
            static_cast<uint8_t>(chip::app::Clusters::WiFiNetworkDiagnostics::WiFiConnectionStatus::kNotConnected));
    }
